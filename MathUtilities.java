...
return baseValue - difference;
    ...
    public Short subtract(short baseValue, short difference) {
         int intResult = baseValue - difference;
         Integer intResult2 = new Integer(intResult);
         short shortResult = intResult2.shortValue();
         return shortResult;
    }
    ...
    public Integer multiply(int multiplicand, int multiplier) {
        return (Integer)(multiplicand * multiplier );
    }
